...
### iSeeBetter
В процессе работы выяснилось, что достаточно простого upscaling'a. Выбор пал на модель iSeeBetter. Модель показывает отличные результаты, однако на видеокарте Tesla T4 обработка каждого кадра занимает в среднем 2.3 секунды, это при upscale только в два раза. Чтобы увеличить в 4 раза необходимо минимум 16 гб видеопамяти.  
